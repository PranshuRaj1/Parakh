...
ALTER TABLE reviews ADD COLUMN IF NOT EXISTS trigger_reason TEXT 
...
INSERT INTO repo_settings (repo, reply_mode) VALUES ('PranshuRaj1/Parakh', 'all_comments') ON CONFLICT DO NOTHING;
